      ...
      <div className="columns is-vcentered">
        ...
        <div className="column card-content is-three-fifths pt-0">
          ...
          <div className="has-text-justified projectSpiel">
            ...
            <br />
            <p>The program allows users to browse 100 cocktail recipes by base alcohol, or if they can't decide, gives them a random cocktail to try. We used the cocktailsDB API to seed our data and deployed on GitHub pages.</p>
            <br />
          </div>
          <div className="is-flex-direction-column">
            <div className="is-flex">
